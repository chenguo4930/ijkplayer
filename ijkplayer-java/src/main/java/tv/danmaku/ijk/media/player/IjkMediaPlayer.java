...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setDataSource(String path)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        mDataSource = path;
        _setDataSource(path, null, null,mEncrypt);
    }
    ...
    private native void _setDataSource(String path, String[] keys, String[] values,int encrypt)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;
    ...
    public void setEncrypt(int encrypt) throws IllegalStateException {
  //      _setEncrypt(encrypt);
        mEncrypt = encrypt;
        Log.e(TAG, "setEncrypt: encrypt 222222222= "+encrypt );

    }
   // public native void _setEncrypt(int encrypt) throws IllegalStateException;
